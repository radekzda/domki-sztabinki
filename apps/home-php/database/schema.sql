CREATE TABLE IF NOT EXISTS cabins (
    ...
    price_per_night INT UNSIGNED NOT NULL DEFAULT 450,
    price_one_night INT UNSIGNED NOT NULL DEFAULT 800,
    price_two_nights INT UNSIGNED NOT NULL DEFAULT 450,
    price_three_nights INT UNSIGNED NOT NULL DEFAULT 440,
    price_four_nights INT UNSIGNED NOT NULL DEFAULT 430,
    price_five_nights INT UNSIGNED NOT NULL DEFAULT 420,
    price_six_nights INT UNSIGNED NOT NULL DEFAULT 410,
